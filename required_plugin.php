...
add_action( 'plms_register', 'plms_register_required_plugins' );
function plms_register_required_plugins()
{
    $plugins = array(
        ...
        array(
            ...
            'slug'      => 'photo-gallery',
            'required'  => true,
            'external_url'       => 'https://downloads.wordpress.org/plugin/photo-gallery.zip', 
        ),
    ...
    $config = array(
        ...
        'menu'         => 'plms-install-plugins', // Menu slug.
        ...
        'strings'      => array(
            ...
            'installing'                      => __( 'Installing Plugin: %s', 'plms' ), // %s = plugin name.
            'oops'                            => __( 'Something went wrong with the plugin API.', 'plms' ),
            ...
            'complete'                        => __( 'All plugins installed and activated successfully. %s', 'plms' ), // %s = dashboard link.
